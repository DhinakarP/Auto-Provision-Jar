...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Connection.Response res = Jsoup.connect(loginUrl).data("j_username", "dhinakartest@gmail.com")
					.data("j_password", "boss643ace435").referrer("https://www.installrapp.com/")
					.userAgent(
		...
		/*	JSONObject data = new JSONObject("data.json");
			...
			String json = Jsoup.connect("https://www.installrapp.com/adprobot/validate.json")
					.data("email", "venkat86.careers@gmail.com", "password", "Hassine123*", "app", appid)
					.cookie("JSESSIONID", res.cookie("JSESSIONID"))
					.referrer("https://www.installrapp.com/dashboard/index")
					.userAgent(
							"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.94 Safari/537.36")
